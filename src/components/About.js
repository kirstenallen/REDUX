...
return (
  ...
  className="stacked absolute flex flex-col h-5/6 w-11/12 sm:w-full md:w-10/12 lg:w-11/12 xl:w-11/12 2xl:w-11/12   text-left  sm:!-left-[0px] rounded-lg" id="about">
